...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MoWa Loans — Loan Client Tracker" },
      {
        name: "description",
        content:
          "MoWa Loans: track borrowers, loans in Zambian Kwacha and repayments with 40% interest.",
      },
      { property: "og:title", content: "MoWa Loans — Loan Client Tracker" },
      {
